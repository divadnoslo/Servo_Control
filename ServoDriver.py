...
class ServoDriver:
    ...
    def setAngle(self, channel, theta):
        ...
        d = int(((theta + 90) * ((2710-390)/180)) + 390)
    
        # Use Previously Defined Class Method
        self.setServoPulse(channel, d)
    
    def center(self, channel):
        "Center the Servo Motor to 0 deg"
        self.setServoPulse(channel, int(1550))